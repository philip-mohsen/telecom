...
class TechnologyServiceRepository(Repository[TechnologService]):
    ...
    def add(self, technology_service: TechnologService) -> None:
    ...
    def get_by_uuid(self, uuid: str) -> TechnologService:
    ...
    def update(self, technology_service: TechnologService) -> None:
        pass

    def delete(self, uuid: str) -> None:
        pass

    def get_all(self) -> list[TechnologService]:
        pass
